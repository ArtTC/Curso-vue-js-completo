<template>
	<div id="app" class="container-fluid">
		...
		<!-- type: transition, animation - Define que 'manda'. -->
		<!-- appear: A transição aparece no carregamento da aplicação. -->
		...
		<!-- <transition :name="tipoAnimacao" mode="out-in"> -->
			<!-- Para a troca funcionar é necessário a 'key'. -->
		...
		<!-- :css="false" - Desativa o css no transition -->
		<!-- <transition
			:css="false"
